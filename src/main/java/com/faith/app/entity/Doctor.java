...
public class Doctor {
	...
	public Doctor(int docId, int staffId, Staff staff, int specialiseId, Specialization specialization,
			double consultationfee, String doctorName, String isActive, Date createdDate) {
		super();
		this.docId = docId;
	...
	public String toString() {
		return "Doctor [docId=" + docId + ", staffId=" + staffId + ", staff=" + staff + ", specialiseId=" + specialiseId
				+ ", specialization=" + specialization + ", consultationfee=" + consultationfee + ", doctorName="
				+ doctorName + ", isActive=" + isActive + ", createdDate=" + createdDate + "]";
	}
