...
public class Patient {
	...
	public Patient(int patientId, String patientName, Date dob, String mobileno, String gender, String bloodGroup,
	...
	public String toString() {
		return "Patient [patientId=" + patientId + ", patientName=" + patientName + ", dob=" + dob + ", mobileno=" + mobileno
